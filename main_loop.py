...
class main_loop:
    ...
    def __init__(self, serialport='/dev/ttyACM1',x_arm_adj=0,y_arm_adj=0):
        ...
        #calibration XY cam par rapport au XY du bras
        self.x_arm_adj=2.62 #origine X offset
        self.y_arm_adj=8.85 #origine Y offset
    ...
    def truncate(self, n, decimals=0):
        #formattage des nombres pour communication série
        n=float(n)
